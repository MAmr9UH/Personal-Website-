...
const OceanSection = () => {
  ...
  return <section id="ocean" className="relative min-h-screen bg-gradient-ocean">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {skills.map((skill, index) => <div key={index} className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-lg px-6 py-3 hover:border-primary/30 transition-all">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {researchAreas.map((area, index) => <Card key={index} className="bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 transition-all duration-300 p-8 group hover:shadow-glow">
          ...
          <div className="mb-16">
            ...
            <div className="space-y-6">
              {highlights.map((highlight, index) => <Card key={index} className="bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 transition-all p-6">
                  <p className="text-muted-foreground leading-relaxed">
                    {highlight}
                  </p>
                </Card>)}
